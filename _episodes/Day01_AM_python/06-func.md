...
At this point,
we've written code to analyze our climate data,
...
we can make our climate analysis easier to read and easier to reuse.
...
TODO: 
Do something else here, because nothing suspicious in climate data.
Or alternatively, we could artificially introduce some problems into the climate data.
...
~~~
numpy.loadtxt('temperature/wvu.temperature.csv', delimiter=',')
~~~
{: .python}
...
~~~
numpy.loadtxt('temperature/wvu.temperature.csv', ',')
~~~
{: .python}
...
----> 1 numpy.loadtxt('temperature/wvu.temperature.csv', ',')
...
~~~
numpy.loadtxt('wvu.temperature.csv', ',')
~~~
{: .python}
