...
In the last lesson,
we wrote some code that plots some values of interest from our first temperature dataset (`01.temperature.csv`).

![Analysis of 01.temperature.csv](../fig/03-loop_2_0.png)
