...
How can we use Python to automatically recognize differences between files,
...
TODO:
There are no suspicious conditions in the climate data, but maybe an 
alternative exercise would be appropriate? For example, loop through years and print if it's a record high/low, or if it's above or below average.
